...
_COMPAT_EMPLOYEE_PROFILE_PREFIX = "compat-ep-"
_COMPAT_ROLE_ID_PREFIX = "compat-role-"
...
async def me_access_context(
    ...
    scope = AccessContextScope(
        employee_profile_id=f"{_COMPAT_EMPLOYEE_PROFILE_PREFIX}{auth.user_id}",
