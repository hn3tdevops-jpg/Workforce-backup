...
def test_pwd_context_available():
    from apps.api.app.core.security import pwd_context
...
def test_role_importable_from_auth():
    from apps.api.app.models.auth import Role
    assert Role.__tablename__ == "roles"


def test_user_roles_table_importable():
    from apps.api.app.models.auth import user_roles
...
def test_routes_auth_re_export():
    from apps.api.app.api.routes.auth import router
