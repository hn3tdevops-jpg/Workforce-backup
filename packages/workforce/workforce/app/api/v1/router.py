...
from apps.api.app.api.v1.auth.routes import router as auth_router
from apps.api.app.api.v1.auth.bootstrap import router as bootstrap_router
from apps.api.app.api.v1.control.routes import router as control_router
from apps.api.app.api.v1.tenant.routes import router as tenant_router
from apps.api.app.api.v1.worker.routes import router as worker_router
from apps.api.app.api.v1.agent.routes import router as agent_router
from apps.api.app.api.v1.timeclock.routes import worker_router as tc_worker_router, tenant_router as tc_tenant_router
from apps.api.app.api.v1.marketplace.routes import (
    public_router as mkt_public,
    worker_router as mkt_worker,
    tenant_router as mkt_tenant,
)
from apps.api.app.api.v1.schedule.routes import router as schedule_router
from apps.api.app.api.v1.dashboard.routes import (
    control_router as dash_control_router,
    tenant_router as dash_tenant_router,
    worker_router as dash_worker_router,
)

from apps.api.app.api.v1.messaging.routes import (
    worker_router as msg_worker_router,
    tenant_router as msg_tenant_router,
    external_router as msg_external_router,
)
from apps.api.app.api.v1.hkops.routes import (
    worker_router as hk_worker_router,
    tenant_router as hk_tenant_router,
    control_router as hk_control_router,
)

from apps.api.app.api.v1.me.routes import router as me_router
