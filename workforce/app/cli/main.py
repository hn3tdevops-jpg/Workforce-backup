...
from app.cli.seed_demo import run_seed
from app.cli.seed_hk_demo import run_hk_seed
from app.cli.seed_roles import run_seed_roles
...
def cmd_match(args):
    ...
    from app.services.matching import find_candidates_for_shift
