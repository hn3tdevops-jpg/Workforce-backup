...
# Prefer canonical packaged Employee model when available, unless the test
# harness requests local models via SKIP_WORKFORCE_MODELS. This lets the
# consolidation proceed safely while preserving test behavior.
