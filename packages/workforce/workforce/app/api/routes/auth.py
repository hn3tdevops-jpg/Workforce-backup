...
it can be included from apps.api.app.main or other entry points without duplication.
...
"""
from apps.api.app.api.v1.auth.routes import router  # noqa: F401 — re-export
