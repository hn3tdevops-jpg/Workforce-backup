...
@pytest.mark.asyncio
async def test_shifts_requires_authentication(client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_shifts_allows_user_with_time_read(
    client: AsyncClient,
    db_session: AsyncSession,
) -> None:
...
@pytest.mark.asyncio
async def test_shifts_forbids_user_without_permission(
    client: AsyncClient,
    db_session: AsyncSession,
) -> None:
    token, _business_id = await seed_user(
